    ...
    <>
      ...
      {showBulkCreate && (
        <BulkCreateUsersModal
          ...
          onSaved={() => {
            // Deliberately NOT auto-closing the modal here — the admin
            // still needs to click "Download credentials" for the
            // generated passwords before the modal goes away, since those
            // are only ever shown once.
            refetchUsers();
          }}
        />
      )}
...
// Creates brand-new accounts from a name,email,role CSV, backed by
// POST /admin/users/bulk-import (see rbac.routes.js).
//
// Very small CSV split — doesn't handle quoted commas, fine for this
// three-column shape.
